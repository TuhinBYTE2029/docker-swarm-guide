(function () {
  ...
  const GUIDE_PATHS = [
    ...
    'https://raw.githubusercontent.com/TheDecipherist/docker-swarm-guide/main/GUIDE.md' // Fallback
  ];
  ...
  async function loadGuide() {
    ...
    try {
      ...
      content.innerHTML =
        ...
        '<ul>' +
        '<li><a href="https://github.com/TheDecipherist/docker-swarm-guide/blob/main/GUIDE.md">View on GitHub</a></li>' +
